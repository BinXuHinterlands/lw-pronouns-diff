            ...
            <form id="LwRegistrationForm" class="lw-form" method="post">
               ...
               <div class="lw_tabcontent">
                  ...
                  <div class="lw-form-group">
                     ...
                     <input type="text" value="<?php echo isset($prePouplateData['last_name'])?stripcslashes($prePouplateData['last_name']):""; ?>"  placeholder="Your Last Name" class="required lettersonly"  id="lw_last_name" name="lw_last_name" maxlength="100">
                  </div>
                  <div class="lw-form-group">
                  ...
                  <div class="lw-form-group">
                     ...
                     <input readonly type="email" placeholder="Your Email Address" value="<?php echo isset($prePouplateData['email'])?stripcslashes($prePouplateData['email']):""; ?>" class="required email validateEmail validateEmailEdu"  id="lw_email_address" name="lw_registration_email_address" maxlength="100">
                  </div>
                  <div class="lw-form-group">
...
</span></div></label><input type="text" placeholder="Your Emergency Contact's Last Name" class="required lettersonly" name="lw_registration_guardian_last_name" maxlength="100">
                  </div>
                  <div class="lw-form-group">
