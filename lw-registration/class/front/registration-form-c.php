...
<div class="lw-width50 lw-white-bg">
   <div class="lw-forma-wrapper lw-form-frame" id="lw-rego-form-general">
      <div class="lw-form-frame-inner">
         <h2>Become a member</h2>
         <div class="lw-forma-wrapper">
            <form id="LwRegistrationForm" class="lw-form" method="post" enctype="multipart/form-data">
               <input type="hidden" name="lw_form_type" id="lw_form_type" value="form_c" />
               ...
               <div class="lw_tabcontent">
                  <div class="lw-form-group">
                     ...
                     <input type="text" placeholder="Your First Name" class="required lettersonly"  name="lw_first_name" id="lw_first_name" maxlength="100">
                  </div>
                  <div class="lw-form-group">
                     ...
                     <input type="text" placeholder="Your Last Name"  class="required lettersonly"  id="lw_last_name" name="lw_last_name" maxlength="100">
                  </div>
                 <div class="lw-form-group">
               	 ...
               	 <div class="lw-form-group">
                     ...
                     <div class="lw-form-group">
                     <label>State / Location<span class="lw_required_label">*</span><div class="lw-tooltip">?<span class="lw-tooltiptext">your state / location helps us schedule any calls in your time zone.</span></div></label>
                     ...
                     <div class="lw-form-group lw-checkbox-custome">
                     <h2>Have you or your sibling spent time in hospital and/or have a chronic or serious health condition or disability?</h2>
                    
                      <label class="lw-customcheck">Yes
                     <input type="radio" name="lw_sibling_spent_time" value="yes" class="lw_sibling_spent_time">
                     <span class="checkmark"></span> </label> 
                     <label class="lw-customcheck">No
                     <input type="radio" name="lw_sibling_spent_time" value="no">
                     <span class="checkmark"></span> </label>
                   <div class="error-lw_sibling_spent_time error"></div>
                  </div>
                  <div class="lw-form-group">
                     ...
                     <input type="email" placeholder="Your Email Address" value="<?php echo isset($prePouplateData['email'])?$prePouplateData['email']:""; ?>" class="required email validateEmail validateEmailEdu"  id="lw_email_address" name="lw_registration_email_address" maxlength="100">
                  </div>
                  <div class="lw-form-group lw_mobilephone">
                     ...
                     <input type="text" placeholder="Your Phone Number" class="phone_number_validation_step_1 number" name="lw_mobilephone" maxlength="100">
                  </div>
...
If you are over 18 this is a trusted adult that we can reach in case of an emergency</span></div></label>
                     <input type="text" placeholder="Your Emergency Contact's First Name" class="required lettersonly"  name="lw_registration_guardian_first_name" maxlength="100">
                  </div>
                  <div class="lw-form-group">
...
If you are over 18 this is a trusted adult that we can reach in case of an emergency
                     ...
                     <input type="text" placeholder="Your Emergency Contact's Last Name" class="required lettersonly" name="lw_registration_guardian_last_name" maxlength="100">
                  </div>
                  <div class="lw-form-group">
...
If you are over 18 this is a trusted adult that we can reach in case of an emergency
                     ...
                     <input type="email" placeholder="Your Emergency Contact's Email" class="email validateEmail required"  name="lw_registration_guardian_email" maxlength="100">
                  </div>
                  <div class="lw-form-group">
...
If you are over 18 this is a trusted adult that we can reach in case of an emergency
			...
			<select name="lw_emergency_area_code" id="lw_emergency_area_code">
                     ...
                     <input type="text" placeholder="Your Emergency Contact's Phone Number" class="required lw_emergency_phone_number phone_number_validation number" name="lw_registration_guardian_mobile_phone" maxlength="100">
                  </div>
                   ...
                   <div class="lw-form-group">
                     ...
                     <textarea placeholder="Tell us a good time to call, or any other communication preferences " name="lw_contact_you" maxlength="1000"></textarea>
                  </div>
               </div>
               <div class="lw_tabcontent">
                  <div class="lw-form-group">
                     ...
                     <input type="text" placeholder="Livewire Username" class="required username_not_same username_valid user_3_consecutive"  id="lw_username"    name="lw_username" maxlength="100">
                  ...
                  <div class="lw-form-group">
                     <label>Create a password<span class="lw_required_label">*</span><div class="lw-tooltip">?<span class="lw-tooltiptext">Passwords must be at least 12 characters, and must contain a number, a symbol (e.g. @,!,#), and a mix of upper/lower case letters. Passwords cannot contain sequential numbers or common words.</span></div></label>
                      ...
                      <!--                            class="required check12_to_20 checkupper checklower checkdigit  checkspecial" -->

                    <i class="far fa-eye" id="lwtogglePassword"></i>
<!--                     --><?php //?>
                      <small  class="lw_notes" id="lw_passwordnotes"></small><?php ?>
                  </div>
                  ...
                  <div class="lw-form-group lw-checkbox-custome lw-checkbox-custome-tc">
                     <input type="checkbox" id="lw_tc" name="lw_tc" value="1" class="chk_privacy_policy">
                                   ...
                                   <label for="tc"> I agree to the Livewire <a href="<?php echo site_url().'/terms-conditions' ?>" target="_blank">Terms & Conditions </a> and <a href="<?php echo site_url().'/privacy' ?>" target="_blank">Privacy Statement</a></label>
